...
| Continuous performance monitoring | `samber/cc-skills-golang@golang-observability` (Datadog Continuous Profiler) | Flight recorder is for one-shot diagnosis, not continuous collection |
